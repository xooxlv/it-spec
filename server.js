...
const acitvityes = {
    ...
    list: [
        ...
        },
        {
            ...
            'long_description_main': 'Наша команда исследователей изучает новые технологии и инновации, чтобы создать решения, которые изменят будущее. Мы исследуем области, такие как искусственный интеллект, блокчейн и квантовые вычисления, чтобы создать новые возможности для бизнеса и общества.',
            'long_description_secondary': 'Мы сотрудничаем с университетами и научными учреждениями, чтобы остаться на передовой технологий и создать новые решения для реальных проблем.'
        },
        {
            ...
            'long_description_main': 'Наша команда модельеров и симуляционистов создает модели и симуляции, которые помогают понять и анализировать сложные системы. Мы используем языки программирования, такие как Python и MATLAB, для создания эффективных и точных моделей.',
            'long_description_secondary': 'Мы разрабатываем модели и симуляции для различных отраслей, включая финансы, здравоохранение и образование.'
        },
        {
            ...
            'long_description_main': 'Наша команда разработчиков ИИ создает алгоритмы машинного обучения и ИИ, которые помогают решать сложные задачи и оптимизировать процесы.'
